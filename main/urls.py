...
from .views import create_product_ajax, delete_product, login_user, logout_user, show_product, register_user, show_json, show_json_by_id, show_main, create_product, show_xml, show_xml_by_id, update_product
